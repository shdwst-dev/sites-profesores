    ...
    return (
        <div className="space-y-10 pb-20 selection:bg-rose-500/30">
            ...
            <header className="flex justify-between items-start md:items-center flex-col md:flex-row gap-4 mb-8">
                <div>
                    <h1 className="text-xl sm:text-3xl font-black text-white tracking-tight uppercase">Recursos Sistemas</h1>
                                            ...
                                            {(Array.isArray(formData.content?.steps) ? formData.content.steps : []).map((s: any, idx: number) => (
                                                <div key={idx} className="flex gap-2 items-start">
                                                    <div className="w-12 shrink-0">
                                                        <input
                                                            type="text"
                                                            className="w-full bg-slate-950 border border-white/10 rounded-lg px-2 py-2 text-white text-xs font-mono text-center focus:border-rose-500 outline-none"
                                                            value={s.step}
                                                            onChange={e => {
                                                    ...
                                                    <input
                                                        type="text"
                                                        className="flex-1 bg-slate-950 border border-white/10 rounded-lg px-3 py-2 text-white text-sm focus:border-rose-500 outline-none"
                                                        value={s.text}
                                                        onChange={e => {
                                                            const steps = [...formData.content.steps];
